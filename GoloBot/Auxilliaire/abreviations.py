...
Doc Cron : [ici]({docs['crontab']}) et [là]({docs['cron']}).""",
		...
		"droprates" : DocCommand("Indique le nombre de lootbox attendu pour une certaine probabilité de drop.",
				...
				Arg("nb_item", "Nombre de drops souhaité. Doit être un entier précédé par =, <=, >=, < ou >", False),
				Arg("nb_box", "Liste des nombres de lootboxes souhaités. Permet d'affiner les stats. Séparer par ;", False),
